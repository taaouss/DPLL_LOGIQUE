...
let rec solveur_dpll_rec clauses interpretation =
  ...
  |Some u -> solveur_dpll_rec (simplifie clauses u) (u::interpretation)
  | _ -> match (pur clauses) with 
        |Some p -> solveur_dpll_rec (simplifie clauses p) (p::interpretation)
        | _ -> solveur_split clauses interpretation 
